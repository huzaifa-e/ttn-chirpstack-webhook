...
export function IMUChart({ uplinks }: { uplinks: Uplink[] }) {
  ...
  return (
    <ChartWrapper label="IMU Beschleunigung" isZoomed={zoom.isZoomed} onReset={zoom.resetZoom} containerRef={zoom.containerRef} isDragging={zoom.isDragging} onDoubleClick={zoom.onDoubleClick}>
      <ResponsiveContainer width="100%" height={250}>
        <LineChart data={zoom.zoomedData} {...zoom.chartProps}>
          ...
          <Line dataKey="ax" name="aX" stroke="#ef4444" strokeWidth={1.5} dot={false} isAnimationActive={false} />
          <Line dataKey="ay" name="aY" stroke="#10b981" strokeWidth={1.5} dot={false} isAnimationActive={false} />
          <Line dataKey="az" name="aZ" stroke="#3b82f6" strokeWidth={1.5} dot={false} isAnimationActive={false} />
